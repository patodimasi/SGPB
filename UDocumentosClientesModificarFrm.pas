unit UDocumentosClientesModificarFrm;
...
type
  TDocumentosClientesModificarFrm = class(TForm)
    lblCodigo: TLabel;
    edtCodigo: TEdit;
    btnBuscar: TButton;
...
var
  DocumentosClientesModificarFrm: TDocumentosClientesModificarFrm;

implementation

{$R *.dfm}

procedure TDocumentosClientesModificarFrm.btnVolverClick(Sender: TObject);
begin
  self.Close;
end;

procedure TDocumentosClientesModificarFrm.btnLimpiarClick(Sender: TObject);
begin
...
procedure TDocumentosClientesModificarFrm.btnBuscarClick(Sender: TObject);
var
 sSQL: string;
 Varios: TDVarios;
 Ret: boolean;
...
procedure TDocumentosClientesModificarFrm.btnConfirmarClick(Sender: TObject);
var
 sSQL: string;
 Varios: TDVarios;
 UsuarioV: string;
...
procedure TDocumentosClientesModificarFrm.btnDirClick(Sender: TObject);
var
 sDir: string;
begin
...
procedure TDocumentosClientesModificarFrm.edtCodigoEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Ingrese el código del Documento a modificar'
end;

procedure TDocumentosClientesModificarFrm.btnBuscarEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Busca el código del Documento ingresado en la base de datos';
end;

procedure TDocumentosClientesModificarFrm.edtUbicacionEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Ingrese la ubicación del archivo con el Documento';
end;

procedure TDocumentosClientesModificarFrm.btnDirEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Seleccione la carpeta donde se encuentra el Documento';
end;

procedure TDocumentosClientesModificarFrm.btnConfirmarEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Modifica el Documento especificado';
end;

procedure TDocumentosClientesModificarFrm.btnVolverEnter(Sender: TObject);
begin
  self.StbDocumentosClientes.SimpleText:= 'Regresa a la pantalla anterior';
end;

procedure TDocumentosClientesModificarFrm.btnLimpiarEnter(Sender: TObject);
begin
