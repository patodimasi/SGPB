...
begin
self.stbInstructivos_Subinstructivos.SimpleText:='Ingrese el código del Documento a modificar';
end;
...
begin
  self.stbInstructivos_Subinstructivos.SimpleText:= 'Busca el código del Documento ingresado en la base de datos';
end;

procedure TInstructivos_SubinstructivosModificarFrm.edtUbicacionEnter(Sender: TObject);
begin
  self.stbInstructivos_Subinstructivos.SimpleText:= 'Ingrese la ubicación del archivo con el Documento';
end;
