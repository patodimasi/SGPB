...
begin
  ...
  sSql:= 'Select PLN_CODIGO as Código, PLN_NRO_REV as NºRev, PLN_DESCRIPCION as Descripción,PLN_SUPERADO' +
         ' from MATERIALES where PLN_CODIGO ='+ QuotedStr(self.edtCodigoM.Text) + 
         ' union ' +
         'select PLN_CODIGO as Código, PLN_NRO_REV as NºRev, PLN_DESCRIPCION as Descripción,PLN_SUPERADO' +
...
begin
stbPlano.SimpleText:= 'Busca el código de la Lista de Material a dar de Baja';
end;
...
begin
 ...
 begin
    ...
    ShowMessage('Debe ingresar el código correspondiente a la Lista de Materiales que desea dar de baja');
...
begin
  self.stbPlano.SimpleText:= 'Ingrese el código de la Lista de Materiales a dar de baja'
end;
