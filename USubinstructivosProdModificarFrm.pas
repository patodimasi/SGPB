...
begin
  self.StbSubinstructivosProd.SimpleText:= 'Ingrese el código del Documento a aprobar'
end;

procedure TModificarSubinstructivosFrm.btnBuscarEnter(Sender: TObject);
begin
  self.StbSubinstructivosProd.SimpleText:= 'Busca el código del Documento ingresado en la base de datos';
end;

procedure TModificarSubinstructivosFrm.edtUbicacionEnter(Sender: TObject);
begin
  self.StbSubinstructivosProd.SimpleText:= 'Ingrese la ubicación del archivo con el Documento';
end;
