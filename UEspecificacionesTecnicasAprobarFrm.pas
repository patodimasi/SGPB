...
begin
  self.StbEspTec.SimpleText:= 'Ingrese el código del Documento a Aprobar'
end;

procedure TEspecificacionesTecnicasAprobarFrm.btnBuscarEnter(Sender: TObject);
begin
  self.StbEspTec.SimpleText:= 'Busca el código del Documento ingresado en la base de datos'
end;
