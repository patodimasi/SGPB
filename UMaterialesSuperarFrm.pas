...
begin
  ...
  begin
    ...
    showMessage ('Debe ingresar el código correspondiente a la Lista de Materiales que desea superar');
  ...
  begin
    ...
    begin
      self.edtCodigo.Color:= clRed;
      showMessage('El código que ingreso no corresponde a una Lista de Materiales en condiciones de ser superada');
      self.edtCodigo.Color:= clwindow;
      self.edtCodigo.SetFocus;
    end;
...
begin
  self.stbMateriales.SimpleText:= 'Ingrese la descripción de la nueva revisión de la Lista de Materiales';
end;

procedure TMaterialesSuperarFrm.btnBuscarEnter(Sender: TObject);
begin
  self.stbMateriales.SimpleText:= 'Busca el código de la Lista de Materiales a Superar';
end;
...
begin
 ...
 HOLA:= self.ADODataSet1.fieldByName('PLN_UBICACION').AsString;
  ...
  begin
    ...
    ShowMessage('La Lista de Materiales ' + ' se superó satisfactoriamente');
...
begin
  self.stbMateriales.SimpleText:= 'Ingrese el código de la Lista de Materiales a superar';
end;
