...
begin
  ...
  begin
    ...
    ShowMessage('Debe ingresar el código correspondiente al plano que desea superar');
  ...
  begin
    ...
    begin
      edtCodigo.Color:= clYellow;
      ShowMessage('El código que ingresó no corresponde a un plano en condiciones de ser superado');
      edtCodigo.Color:= clWindow;
      edtCodigo.SetFocus;
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ShowMessage('El plano ' + FPlano.Codigo + ' se superó satisfactoriamente');
      PlanoNuevo.Free;
...
begin
  stbPlano.SimpleText:= 'Ingrese el código de plano a superar';
end;

procedure TPlanoSuperarFrm.edtDescripcion2Enter(Sender: TObject);
begin
  stbPlano.SimpleText:= 'Ingrese la descripción de la nueva revisión del plano';
end;

procedure TPlanoSuperarFrm.btnBuscarEnter(Sender: TObject);
begin
  stbPlano.SimpleText:= 'Busca el código del plano a superar';
